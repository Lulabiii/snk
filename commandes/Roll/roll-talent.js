...
module.exports = {
    ...
    \`\`\` \`\`\`
        ...
        \`\`\` \`\`\`
                        ...
                        collector.stop();
                        await connection.execute(
                            'UPDATE entrainement SET level_force = 2, level_agilite = 2, level_resistance = 2, level_sabre = 2, level_tridi = 2 WHERE id_membre = ?',
                            [memberId]
                        );
                    }
                });
    ...
    \`\`\` \`\`\`
        ...
        \`\`\` \`\`\`
                        ...
                        await connection.execute(
                            'UPDATE entrainement SET level_force = 3 WHERE id_membre = ?',
                            [memberId]
                        );
                        collector.stop();
                    }
        ...
        \`\`\` \`\`\`
            ...
            \`\`\` \`\`\`
                            ...
                            await connection.execute(
                                'UPDATE entrainement SET level_resistance = 3 WHERE id_membre = ?',
                                [memberId]
                            );
                            collector.stop();
                        }
...
\`\`\` \`\`\`
    ...
    \`\`\` \`\`\`
                    ...
                    await connection.execute(
                        'UPDATE entrainement SET level_tridi = 2 WHERE id_membre = ?',
                        [memberId]
                    );
                    collector.stop();
                }
    ...
    \`\`\` \`\`\`
        ...
        \`\`\` \`\`\`
                        ...
                        await connection.execute(
                            'UPDATE entrainement SET level_sabre = 2 WHERE id_membre = ?',
                            [memberId]
                        );
                        collector.stop();
                    }
...
\`\`\` \`\`\`
                ...
                await connection.execute(
                    'UPDATE entrainement SET level_force = 2 WHERE id_membre = ?',
                    [memberId]
                );
                collector.stop();
            }
...
\`\`\` \`\`\`
    ...
    \`\`\` \`\`\`
                    ...
                    await connection.execute(
                        'UPDATE entrainement SET level_agilite = 2 WHERE id_membre = ?',
                        [memberId]
                    );
                    collector.stop();
                }
...
\`\`\` \`\`\`
                ...
                await connection.execute(
                    'UPDATE entrainement SET level_agilite = 1, level_resistance = 1 WHERE id_membre = ?',
                    [memberId]
                );
            }
        }); 
...
\`\`\` \`\`\`
            ...
            await connection.execute(
                'UPDATE entrainement SET level_resistance = 2 WHERE id_membre = ?',
                [memberId]
            );
            collector.stop();
        }
